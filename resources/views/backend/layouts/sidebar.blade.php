...
<a href="{{ url('backend/table') }}" class="brand-link">
<img src="{{ asset('images/logo.png') }}" alt="TIFA Logo" class="brand-image elevation-3" style="opacity: .8">
...
<i class="fas fa-search fa-fw"></i>
	...
	<nav class="mt-2">
		<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
			...
			<p>
			Import
			<span class="right badge badge-danger">Excel/Csv</span>
			</p>
			</a>
			</li>
		</ul>
